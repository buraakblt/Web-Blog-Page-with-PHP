...
<html lang="en">
    <head>
        ...
        <title>Kişisel Blog Sayfamız</title>
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="site-heading">
                            <h1>Hoşgeldiniz!</h1>
                            <span class="subheading">İlk Blog Sitemiz</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    if($kelime != ""){
                        ...
                        $cek = $db->prepare("SELECT * FROM `bloglar` WHERE `aktif` = :aktif 
                        ...
                        $cek = $db->prepare("SELECT * FROM `bloglar` WHERE `aktif` = :aktif ORDER BY `id` DESC");
                        $cek->bindValue(":aktif", 1, PDO::PARAM_INT);
                    }
