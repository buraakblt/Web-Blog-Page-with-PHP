...
if(@$_POST["submit"]){
    ...
    $guncelle = $db->prepare("UPDATE `bloglar` SET `baslik` = :baslik, `alt_baslik` = :alt_baslik, `aciklama` = :aciklama,
    ...
    if($guncelle->execute()){
        header("Location: bloglar.php?i=guncel");
    }else{
        //print_r($ekle->errorInfo());
        header("Location: bloglar.php?i=gunceldegil");
    }
}
?>
    <div id="wrapper">
